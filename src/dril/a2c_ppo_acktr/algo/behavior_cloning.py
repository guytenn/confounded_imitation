...
class BehaviorCloning:
    def __init__(self, policy,  device, batch_size=None, lr=None, expert_dataset=None,
                 num_batches=np.float('inf'), training_data_split=None, envs=None,
                 ensemble_size=None, channels_to_remove=[]):
        ...
        datasets = expert_dataset.preprocess(training_data_split, batch_size, ensemble_size, channels_to_remove)
