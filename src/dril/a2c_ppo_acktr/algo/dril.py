...
import src.dril.a2c_ppo_acktr.ensemble_models as ensemble_models
...
class DRIL:
    def __init__(self, device=None, envs=None, ensemble_policy=None, env_name=None,
                 ...
                 training_data_split=None, channels_to_remove=[]):
        ...
        self.trdata = expert_dataset.preprocess(1.0, 1, self.ensemble_size, channels_to_remove)['trdata']
    ...
    def predict_reward(self, actions, states, action_space):
        ...
        for idx in range(actions.shape[0]):
            ...
            if isinstance(action_space, gym.spaces.Box):
                ...
                ensemble_action = torch.clamp(ensemble_action, action_space.low[0], action_space.high[0])
