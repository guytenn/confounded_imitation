...
def Ensemble(uncertainty_reward=None, device=None, envs=None,
    ...
    num_inputs = envs.observation_space.shape[0] - len(channels_to_remove)
    try:
    ...
    if os.path.exists(ensemble_model_path):
        ...
        for ensemble_epoch in range(num_ensemble_train_epoch):
            ...
            print(f'ensemble-epoch {ensemble_epoch}/{num_ensemble_train_epoch} | '
                  f'train loss: {ensemble_train_loss:.4f},  test loss: {ensemble_test_loss:.4f}')
