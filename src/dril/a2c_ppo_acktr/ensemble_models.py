...
class PolicyEnsembleCNN(nn.Module):
    def __init__(self, num_inputs, n_actions, n_hidden, n_ensemble):
        ...
        self.cnn = nn.Sequential(
            nn.Conv2d(num_inputs, 32, 8, stride=4, padding=0, bias=True), nn.ReLU(),
            nn.Conv2d(32, 64, 4, stride=2, padding=0, bias=True), nn.ReLU(),
            nn.Conv2d(64, 32, 3, stride=1, padding=0, bias=True), nn.ReLU(), Flatten(),
        )
