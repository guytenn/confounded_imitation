...
def get_args():
    ...
    parser.add_argument(
        '--num_ensemble_train_epoch', type=int, default=20,#2001,
    ...
    parser.add_argument(
        '--seed', type=int, default=-1, help='random seed (default: -1 == random seed)')
    parser.add_argument(
        '--cuda-deterministic',
        action='store_true',
        default=False,
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='will remove context from state in data')
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='add env reward when using dril')

    parser.add_argument(
        '--dril-coef',
        type=float,
        default=0.01,
        help='dril reward coef (default: 0.01)')

    parser.add_argument(
        '--run-name',
        default='',
        help='wandb run_name (default: "empty")')
