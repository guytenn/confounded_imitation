...
from src.rllib.models.jax.jax_action_dist import JAXCategorical
from src.rllib.models.modelv2 import ModelV2
from src.rllib.models.preprocessors import get_preprocessor, Preprocessor
...
from src.rllib.utils.annotations import DeveloperAPI, PublicAPI
...
from src.rllib.utils.spaces.simplex import Simplex
from src.rllib.utils.spaces.space_utils import flatten_space
...
class ModelCatalog:
    ...
    def get_model_v2(obs_space: gym.Space,
        ...
        if model_config.get("custom_model"):
            ...
            if framework in ["tf2", "tf", "tfe"]:
                ...
                if model_config.get("use_lstm") or \
                    ...
                    from src.rllib.models.tf.attention_net import \
                        AttentionWrapper, Keras_AttentionWrapper
                    from src.rllib.models.tf.recurrent_net import \
                ...
                if model_config.get("use_lstm") or \
                        model_config.get("use_attention"):
                    from src.rllib.models.torch.attention_net import \
                        AttentionWrapper
                    from src.rllib.models.torch.recurrent_net import \
                        LSTMWrapper
        ...
        if framework in ["tf", "tfe", "tf2"]:
            ...
            if model_config.get("use_lstm") or \
                ...
                from src.rllib.models.tf.attention_net import \
                    AttentionWrapper, Keras_AttentionWrapper
                from src.rllib.models.tf.recurrent_net import LSTMWrapper, \
                    Keras_LSTMWrapper
        ...
        # Find a default TorchModelV2 and wrap with model_interface.
            ...
            if model_config.get("use_lstm") or \
                ...
                from src.rllib.models.torch.attention_net import \
                    AttentionWrapper
                from src.rllib.models.torch.recurrent_net import LSTMWrapper
    ...
    def _get_v2_model_class(input_space: gym.Space,
        ...
        if framework in ["tf2", "tf", "tfe"]:
            from src.rllib.models.tf.fcnet import \
                FullyConnectedNetwork as FCNet, \
                Keras_FullyConnectedNetwork as Keras_FCNet
            from src.rllib.models.tf.visionnet import \
                VisionNetwork as VisionNet, \
                Keras_VisionNetwork as Keras_VisionNet
            from src.rllib.models.tf.complex_input_net import \
                ComplexInputNetwork as ComplexNet
        elif framework == "torch":
            from src.rllib.models.torch.fcnet import (FullyConnectedNetwork as
                                                      FCNet)
            from src.rllib.models.torch.visionnet import (VisionNetwork as
                                                          VisionNet)
            from src.rllib.models.torch.complex_input_net import \
                ComplexInputNetwork as ComplexNet
        elif framework == "jax":
            from src.rllib.models.jax.fcnet import (FullyConnectedNetwork as
                                                    FCNet)
        else:
            raise ValueError(
