...
from src.rllib.utils.schedules import ConstantSchedule, \
    LinearSchedule, ExponentialSchedule, PiecewiseSchedule
from src.rllib.utils import check, framework_iterator, try_import_tf, \
    try_import_torch
...
class TestSchedules(unittest.TestCase):
    ...
    def test_polynomial_schedule(self):
        ...
        config = dict(
            type="src.rllib.utils.schedules.polynomial_schedule."
            "PolynomialSchedule",
