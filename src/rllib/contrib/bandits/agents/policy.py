...
from src.rllib.contrib.bandits.models.linear_regression import \
...
TS_PATH = "src.rllib.contrib.bandits.exploration.ThompsonSampling"
UCB_PATH = "src.rllib.contrib.bandits.exploration.UCB"
