...
import ray
from src.rllib.agents.qmix.mixers import VDNMixer, QMixer
from src.rllib.agents.qmix.model import RNNModel, _get_size
from src.rllib.env.multi_agent_env import ENV_STATE
from src.rllib.env.wrappers.group_agents_wrapper import GROUP_REWARDS
from src.rllib.evaluation.metrics import LEARNER_STATS_KEY
from src.rllib.models.torch.torch_action_dist import TorchCategorical
from src.rllib.policy.policy import Policy
from src.rllib.policy.rnn_sequencing import chop_into_sequences
from src.rllib.policy.sample_batch import SampleBatch
from src.rllib.models.catalog import ModelCatalog
from src.rllib.models.modelv2 import _unpack_obs
...
class QMixTorchPolicy(Policy):
    ...
    def __init__(self, obs_space, action_space, config):
        ...
        config = dict(src.rllib.agents.qmix.qmix.DEFAULT_CONFIG, **config)
