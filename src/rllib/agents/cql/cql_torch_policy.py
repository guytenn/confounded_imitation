...
from src.rllib.agents.sac.sac_tf_policy import postprocess_trajectory, \
    validate_spaces
from src.rllib.agents.sac.sac_torch_policy import _get_dist_class, stats, \
...
from src.rllib.policy.policy import LEARNER_STATS_KEY
...
from src.rllib.utils.typing import LocalOptimizer, TensorType, \
    TrainerConfigDict
...
CQLTorchPolicy = build_policy_class(
    ...
    framework="torch",
    loss_fn=cql_loss,
    get_default_config=lambda: src.rllib.agents.cql.cql.CQL_DEFAULT_CONFIG,
    stats_fn=cql_stats,
