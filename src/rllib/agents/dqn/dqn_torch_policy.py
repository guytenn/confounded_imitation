...
import gym
import ray
from src.rllib.agents.dqn.dqn_tf_policy import (
    PRIO_WEIGHTS, Q_SCOPE, Q_TARGET_SCOPE, postprocess_nstep_and_prio)
from src.rllib.agents.dqn.dqn_torch_model import DQNTorchModel
...
DQNTorchPolicy = build_policy_class(
    ...
    get_default_config=lambda: src.rllib.agents.dqn.dqn.DEFAULT_CONFIG,
