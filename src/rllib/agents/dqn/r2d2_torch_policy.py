...
import gym
import ray
from src.rllib.agents.dqn.dqn_tf_policy import (PRIO_WEIGHTS,
                                                postprocess_nstep_and_prio)
from src.rllib.agents.dqn.dqn_torch_policy import adam_optimizer, \
    build_q_model_and_distribution, compute_q_values
from src.rllib.agents.dqn.r2d2_tf_policy import \
...
from src.rllib.utils.torch_ops import apply_grad_clipping, FLOAT_MIN, \
...
R2D2TorchPolicy = build_policy_class(
    ...
    framework="torch",
    loss_fn=r2d2_loss,
    get_default_config=lambda: src.rllib.agents.dqn.r2d2.DEFAULT_CONFIG,
