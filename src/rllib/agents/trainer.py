...
from src.rllib.env.utils import gym_env_creator
from src.rllib.evaluation.collectors.simple_list_collector import \
    SimpleListCollector
...
from src.rllib.models import MODEL_DEFAULTS
from src.rllib.policy.policy import Policy, PolicySpec
from src.rllib.policy.sample_batch import DEFAULT_POLICY_ID
from src.rllib.utils import deep_update, FilterManager, merge_dicts
from src.rllib.utils.annotations import Deprecated, DeveloperAPI, override, \
    PublicAPI
from src.rllib.utils.deprecation import deprecation_warning, DEPRECATED_VALUE
from src.rllib.utils.framework import try_import_tf, TensorStructType
from src.rllib.utils.from_config import from_config
from src.rllib.utils.spaces import space_utils
from src.rllib.utils.typing import AgentID, EnvInfoDict, EnvType, EpisodeID, \
...
COMMON_CONFIG: TrainerConfigDict = {
    ...
    # Env class, e.g. "src.rllib.examples.env.random_env.RandomEnv".
    "env": None,
    ...
    # === Debug Settings ===
    # Set the src.rllib.* log level for the agent process and its workers.
    ...
    "exploration_config": {
        ...
        # of your class (e.g. "src.rllib.utils.exploration.epsilon_greedy.
        # EpsilonGreedy").
    ...
    #  - A callable that returns a src.rllib.offline.InputReader.
...
class Trainer(Trainable):
    ...
    def setup(self, config: PartialTrainerConfigDict):
        ...
        if self.config.get("log_level"):
            logging.getLogger("src.rllib").setLevel(self.config["log_level"])
    ...
    def with_updates(**overrides) -> Type["Trainer"]:
        raise NotImplementedError(
            ...
            "that were generated via the `src.rllib.agents.trainer_template."
