...
REWARD_MATRIX = np.array([[0.99, 0.28, 0.59, 0.92, 0.93, 0.94, 0.16, 0.2 , 0.26, 0.47, 0.64, 0.99, 0.06, 0.17, 0.51, 0.03, 0.49, 0.59, 0.31, 0.54],
                          [0.85, 0.22, 0.16, 0.56, 0.74, 0.72, 0.43, 0.99, 0.94, 0.69, 0.19, 0.63, 0.71, 0.02, 0.95, 0.56, 0.12, 0.11, 0.7 , 0.59],
                          [0.04, 0.18, 0.95, 0.85, 0.49, 0.55, 0.59, 0.94, 0.05, 0.6 , 0.16, 0.99, 0.73, 0.05, 0.39, 0.78, 0.51, 0.07, 0.27, 0.  ],
                          [0.98, 0.93, 0.11, 0.7 , 0.49, 0.02, 0.48, 0.79, 0.73, 0.38, 0.52, 0.79, 0.89, 0.48, 0.17, 0.9 , 0.69, 0.05, 0.68, 0.65],
                          [0.14, 0.6 , 0.47, 0.62, 0.69, 0.7 , 0.97, 0.99, 0.79, 0.27, 0.65, 0.65, 0.81, 0.89, 0.91, 0.66, 0.58, 0.86, 0.02, 0.42],
                          [0.  , 0.68, 0.79, 0.48, 0.64, 0.82, 0.15, 0.86, 0.95, 0.77, 0.46, 0.66, 0.08, 0.83, 0.55, 0.81, 0.88, 0.87, 0.2 , 0.19],
                          [0.82, 0.23, 0.67, 0.66, 0.8 , 0.54, 0.18, 0.63, 0.83, 0.26, 0.03, 0.89, 0.69, 0.13, 0.58, 0.78, 0.34, 0.61, 0.96, 0.31],
                          [0.36, 0.86, 0.4 , 0.67, 0.12, 0.22, 0.08, 0.01, 0.67, 0.86, 0.7 , 0.41, 0.12, 0.65, 0.68, 0.16, 0.7 , 0.23, 0.29, 0.48],
                          [0.56, 0.17, 0.05, 0.9 , 0.14, 0.85, 0.54, 0.49, 0.11, 0.45, 0.15, 0.46, 0.57, 0.46, 0.51, 0.79, 0.4 , 0.33, 0.09, 0.53],
                          [0.1 , 0.51, 0.23, 0.67, 0.68, 0.49, 0.68, 0.74, 0.84, 0.7 , 0.01, 0.3 , 0.78, 0.38, 0.47, 0.25, 0.63, 0.49, 0.28, 0.67],
                          [0.45, 0.16, 0.14, 0.23, 0.91, 0.43, 0.05, 0.06, 0.03, 0.74, 0.27, 0.14, 0.96, 0.28, 0.14, 0.82, 0.62, 0.5 , 0.43, 0.89],
                          [0.95, 0.47, 0.6 , 0.49, 0.73, 0.33, 0.25, 0.06, 0.92, 0.05, 0.92, 0.64, 0.57, 0.03, 0.31, 0.61, 0.58, 0.38, 0.18, 0.63],
                          [0.8 , 0.69, 0.67, 0.06, 0.65, 0.61, 0.01, 0.79, 0.25, 0.01, 0.16, 0.29, 0.52, 0.91, 0.15, 0.68, 0.98, 0.65, 0.03, 0.32],
                          [0.8 , 0.83, 0.92, 0.41, 0.69, 0.54, 0.16, 0.79, 0.07, 0.37, 0.12, 0.43, 0.19, 0.01, 0.02, 0.32, 0.12, 0.62, 0.44, 0.  ],
                          [0.55, 0.82, 0.02, 0.9 , 0.91, 0.72, 0.76, 0.22, 0.27, 0.31, 0.72, 0.88, 0.79, 0.22, 0.07, 0.48, 0.17, 0.71, 0.41, 0.6 ],
                          [0.75, 0.62, 0.34, 0.23, 0.97, 0.12, 0.68, 0.24, 0.24, 0.69, 0.37, 0.21, 0.5 , 0.62, 0.42, 0.43, 0.33, 0.26, 0.55, 0.63],
                          [0.32, 0.93, 0.17, 0.6 , 0.55, 0.04, 0.51, 0.17, 0.33, 0.74, 0.11, 0.45, 0.66, 0.86, 0.37, 0.58, 0.82, 0.84, 0.72, 0.68],
                          [0.83, 0.9 , 0.46, 0.16, 0.43, 0.18, 0.92, 0.01, 0.46, 0.07, 0.8 , 0.54, 0.5 , 0.69, 0.64, 0.75, 0.14, 0.2 , 0.1 , 0.8 ],
                          [0.78, 0.4 , 0.56, 0.64, 0.06, 0.26, 0.66, 0.41, 0.56, 0.05, 0.51, 0.67, 0.75, 0.75, 0.47, 0.98, 0.84, 0.84, 0.47, 0.86],
                          [0.57, 0.34, 0.45, 0.71, 0.9 , 0.12, 0.62, 0.69, 0.37, 0.09, 0.39, 0.59, 0.88, 0.24, 0.19, 0.51, 0.02, 0.33, 0.25, 0.4 ]])
